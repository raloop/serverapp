...
export class AppComponent implements OnInit {
  ...
  saveServer(serverForm: NgForm): void {
    this.isLoading.next(true); // start the spinner
    this.appState$ = this.serverService.save$(serverForm.value as Server).pipe(
      map((response) => {
        ...
        this.isLoading.next(false); // stop the spinner
  ...
  printReport(): void {
    // window.print();    // save the report as pdf
    let dataType = 'apllication/vnd.ms-excel.sheet.macroEnabled.12';
